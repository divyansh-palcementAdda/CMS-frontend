...
export class CityDetailComponent implements OnInit, OnDestroy {
  ...
  loadStudents(tab: string): void {
    ...
    this.locationAnalyticsService.getCityStudentsPaged(
      this.cityId, page, size, tab, search, source || '', scholar, sortBy, sortDir, duplicateOnly, showOnlyFoc, showOnlySbs
  ...
  exportStudents(tab: string): void {
    ...
    this.locationAnalyticsService.exportCityStudents(
      this.cityId, tab, search, source, scholar, duplicateOnly, showOnlyFoc, showOnlySbs
    ).subscribe({
