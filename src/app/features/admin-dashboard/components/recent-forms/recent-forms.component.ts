...
@Component({
  ...
  template: `
    <div class="recent-forms-container">
      <h3 class="section-title">Recent Forms Submitted</h3>
            ...
            <tbody>
              <ng-container *ngIf="rows.length; else emptyRows">
                <tr *ngFor="let f of rows; let i = index; trackBy: trackById">
                  ...
                  <td class="name-cell">
                    <span class="user-name">{{ f.fullName || f.name || '—' }}</span>
                  </td>
                  <td>{{ f.email || '—' }}</td>
                  <td>
                  ...
                  <td>
                    <span class="discount-label" [class.has-discount]="(f.discount ?? f.discountPercentage ?? 0) > 0">
                      {{ f.discount ?? f.discountPercentage ?? 0 }}%
                    </span>
                  </td>
                  <td>
                    <div class="actions">
                      <button class="btn-icon view" title="View" (click)="onView(f.id!)">
                      ...
                      <button class="btn-icon edit" title="Edit" (click)="onEdit(f.id!)">
                      ...
                      <button class="btn-icon delete" title="Delete" (click)="onDelete(f)">
                ...
                <tr>
                  <td colspan="7" class="empty-row">
                    <div class="empty-content">
                      <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48" fill="#e5e7eb"><path d="M320-240h320v-80H320v80Zm0-160h320v-80H320v80ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T740-80H240Zm280-520v-200H240v640h500v-440H520Z"/></svg>
                      <p>No recent form submissions found</p>
                    </div>
                  </td>
                </tr>
              </ng-template>
